...
def fsd50k_triggers(fsd_50k: pd.DataFrame, mapping: dict) -> pd.DataFrame:
    ...
    fsd_50k_triggers.loc[:, "labels"] = fsd_50k_triggers["labels"].apply(
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--is_eval", type=str, required=True, default="No", help="Generate samples from eval (True) or dev (False) set"
    )
